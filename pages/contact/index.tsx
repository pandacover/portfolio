    ...
    <motion.div 
      ...
      <div className="mt-12">
        ...
        >
          ...
          <button
            type="submit"
            className="font-medium hover:bg-transparent dark:hover:bg-transparent py-2 bg-emerald-600 text-emerald-100 border-emerald-600 hover:text-emerald-600 dark:bg-emerald-100 dark:text-emerald-900 dark:border-emerald-100 dark:hover:text-emerald-100 border-2 rounded-lg transition flex gap-4 justify-center items-center"
          >
      ...
      <div className="pt-12">
        <h1 className="text-sm text-center text-gray-600 dark:text-gray-300">
          ...
          <Link href="https://www.emailjs.com">
            <a
              target="_blank"
              className="dark:text-emerald-500 text-emerald-700 hover:underline"
            >
              Email.js
            </a>
          </Link>
